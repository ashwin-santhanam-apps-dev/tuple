...
class TupleSpecProcessorIntegrationTest {
    ...
    void shouldCreateTheTupleClassesAndFactoryMethodForDefinitionInClass() {
        JavaFileObject dependant = JavaFileObjects.forSourceLines(
                "com.example.Main",
                "package com.example;",
                "import io.github.amusing_glitch.tuple.dynamic.DynamicTuple;",
        ...
        assertThat(compilation)
                .generatedSourceFile("io.github.amusing_glitch.tuple.dynamic.Tuple2")
                .hasSourceEquivalentTo(JavaFileObjects.forSourceLines(
                        "io.github.amusing_glitch.tuple.dynamic.Tuple2",
                        "package io.github.amusing_glitch.tuple.dynamic;",
                        "public record Tuple2<T0, T1> (T0 item0, T1 item1) {",
                        "   public static final Tuple2 type = null;",
                        "   @Override",
        ...
        assertThat(compilation)
                .generatedSourceFile("io.github.amusing_glitch.tuple.dynamic.Tuple3")
                .hasSourceEquivalentTo(JavaFileObjects.forSourceLines(
                        "io.github.amusing_glitch.tuple.dynamic.Tuple3",
                        "package io.github.amusing_glitch.tuple.dynamic;",
                                "    ",
                                "    ",
                                "    public record Tuple3<T0, T1, T2> (T0 item0, T1 item1, T2 item2) {",
                                "        public static final Tuple3 type = null;",
                                "        @Override",
                                "        public boolean equals(Object obj) {",
    ...
    void shouldCreateTheTupleClassesAndFactoryMethodWhenImportedStatically() {
        JavaFileObject dependant = JavaFileObjects.forSourceLines(
                "com.example.Main",
                "package com.example;",
                "import static io.github.amusing_glitch.tuple.dynamic.DynamicTuple.of;",
                "import static io.github.amusing_glitch.tuple.dynamic.DynamicTuple.zip;",
                "import java.util.stream.Stream;",
                "public class Main {",
                "   public static void main(String[] args) {",
                "       of(\"Alice\", 21);",
    ...
    void shouldCreateTheTupleClassesAndFactoryMethodWhenUsedDirectly() {
        JavaFileObject dependant = JavaFileObjects.forSourceLines(
                ...
                "public class Main {",
                "   public static void main(String[] args) {",
                "       io.github.amusing_glitch.tuple.dynamic.DynamicTuple.of(\"Alice\", 21);",
                "       io.github.amusing_glitch.tuple.dynamic.DynamicTuple.of(\"Alice\", 21);",
                "       io.github.amusing_glitch.tuple.dynamic.DynamicTuple.zip(",
                "           Stream.of(\"Alice\"),",
                "           Stream.of(1),",
                "           Stream.of(false)",
                "       );",
